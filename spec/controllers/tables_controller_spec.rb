  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved table as @table" do
        ...
        post :create, {:table => { "name" => "invalid value" }}, valid_session
        assigns(:table).should be_a_new(Table)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested table" do
        ...
        Table.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => table.to_param, :table => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the table as @table" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Table.any_instance.stub(:save).and_return(false)
        put :update, {:id => table.to_param, :table => { "name" => "invalid value" }}, valid_session
        assigns(:table).should eq(table)
      end
