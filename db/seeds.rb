...
#Accounts
Account.create(:table => Table.find_by_name('12'))
Account.create(:table => Table.find_by_name('15'))
Account.create(:table => Table.find_by_name('21'))
Account.create(:table => Table.find_by_name('30'))
Account.create(:table => Table.find_by_name('32'))
